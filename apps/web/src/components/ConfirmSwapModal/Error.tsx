  ...
  switch (errorType) {
    case PendingModalError.TOKEN_APPROVAL_ERROR:
      return {
        ...
        message: (
          <Trans>
            This provides the Oton protocol access to your token for trading. For security, it expires after 30 days.
          </Trans>
        ),
    ...
    case PendingModalError.WRAP_ERROR:
      return {
        ...
        message: (
          <Trans>
            Swaps on the Oton Protocol can start and end with ETH. However, during the swap ETH is wrapped into WETH.
          </Trans>
        ),
